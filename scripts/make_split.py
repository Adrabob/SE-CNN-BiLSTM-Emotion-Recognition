...
# Actor-based split: group videos by actor ID extracted from folder name.
# Video folder format: "actor12_02-01-06-01-02-02-12" → actor = "actor12"
# This prevents the same actor appearing in both train and test splits,
